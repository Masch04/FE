<template>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="monaNavbarContent">
            ...
            <div class="d-flex align-items-center justify-content-center justify-content-lg-end gap-2">
              ...
              <!-- ẨN 2 NÚT ĐĂNG NHẬP/ĐĂNG KÝ KHI ĐANG Ở TRANG NÀY -->
              <template v-if="!is_check && !isAuthPage">
  ...
  export default {
    ...
    computed: {
      ...
      // MỚI: Ẩn nút đăng nhập/đăng ký khi đang ở trang đăng nhập hoặc đăng ký
      isAuthPage() {
        return ['/khach-hang/dang-nhap', '/khach-hang/dang-ky'].includes(this.$route.path);
      }
    },
    mounted() {
      this.checkLogin();
