<template>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden animate__animated animate__fadeIn">
              <!-- Header vàng cam – CĂN CHỈNH CHUẨN -->
              ...
              <div class="card-body p-4 p-md-5">
                <form @submit.prevent="dangNhap()" class="row g-3">
                  ...
                  <div class="col-12 text-end">
                    <router-link to="/quen-mat-khau" class="text-muted small text-decoration-underline link-glow">
                      Quên mật khẩu?
                    </router-link>
                  </div>
                  ...
                  <div class="col-12 mt-4">
                    ...
                    >
                      <i class="fa-solid fa-lock-open me-2"></i>Đăng Nhập
                    </button>
                  </div>
                </form>
              </div>
  ...
  /* Căn chỉnh chính xác dòng chữ trong header */
  .card-header p {
