<template>
  <div class="login-page min-vh-100 d-flex align-items-center justify-content-center py-5">
    <div class="container">
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card border-0 shadow-lg rounded-4 overflow-hidden animate__animated animate__fadeIn">
            ...
            <div class="card-header bg-gradient text-center py-4 position-relative">
              ...
              <h3 class="mb-3 fw-bold position-relative z-10 text-dark">ĐĂNG NHẬP</h3>
              <p class="mb-0 position-relative z-10 small text-white d-inline-flex align-items-center gap-1 lh-1">
                Bạn chưa có tài khoản?
                <router-link to="/khach-hang/dang-ky" class="text-white fw-bold text-decoration-underline link-glow"
            ...
            <div class="card-body p-4 p-md-5">
              <form @submit.prevent="dangNhap()" class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <input v-model="login.email" type="email" class="form-control form-control-lg rounded-pill"
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <input v-model="login.password" :type="passwordFieldType"
...
@media (max-width: 576px) {
  ...
  .btn-login { font-size: 1rem; padding: 0.75rem !important; }
}
</style>