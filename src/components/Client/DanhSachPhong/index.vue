          ...
          <template v-for="(v, k) in ds_loai_phong" :key="k">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" :data-aos-delay="k * 100">
              <div
                ...
                <div
                  class="p-4 content-hover position-absolute top-0 start-0 w-100 h-100 d-flex flex-column justify-content-center align-items-center text-center bg-white bg-opacity-98">
                  <h5 class="fw-bold text-dark mb-2">{{ v.ten_loai_phong }}</h5>
