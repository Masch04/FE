    ...
    <div class="container">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <div class="featured-card rounded-3 overflow-hidden shadow-lg h-100">
            <div class="row g-0 h-100">
              <div
                class="col-md-8 p-4 p-lg-5 d-flex flex-column justify-content-center"
              >
                ...
                <p class="text-dark mb-0 lh-base">
                  Phòng superior (SUP) là hạng phòng khách sạn cao cấp hơn phòng
                  standard.
                </p>
              </div>
              <div
                class="col-md-4 d-flex align-items-center justify-content-center p-2 bg-white"
              >
                <img
          ...
          <div class="featured-card rounded-3 overflow-hidden shadow-lg h-100">
            <div class="row g-0 h-100">
              <div
                class="col-md-8 p-4 p-lg-5 d-flex flex-column justify-content-center"
              >
                <span class="badge-custom badge-popular mb-3"
                  >Truy cập nhiều nhất</span
                >
      ...
      <div class="row g-4">
        <template v-for="(v, k) in ds_bai_viet" :key="k">
          ...
          >
            <router-link
              :to="'/chi-tiet-bai-viet/' + v.id"
              class="text-decoration-none d-block h-100"
            >
              <div
                class="blog-card rounded-3 overflow-hidden h-100 transition-card"
              >
...
export default {
  ...
  methods: {
    layDuLieuBaiViet() {
      axios
        .get(
          "http://127.0.0.1:8000/api/client/bai-viet/data/" +
            this.slug_chuyen_muc
        )
        .then((res) => {
