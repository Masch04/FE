                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody class="border border-warning border-4">
                            <tr>
                              <th
                                class="align-middle text-light fs-5 text-nowrap"
                              ...
                              <td rowspan="2">
                                <div
                                  class="input-group d-flex justify-content-center flex-row mb-3 mt-5 mb-5"
                            ...
                            <tr>
                              <td>
                                ...
                                <p>
                                  <i
                                    class="fa-solid fa-check me-2 text-success me-2"
                                  ></i>
                              ...
                              <td class="text-center text-nowrap">
                                <p>
                                  <template
                                    v-for="(v, k) in value.so_nguoi_lon"
                                    :key="k"
                                  >
                                    <i
                                      class="text-primary fa-solid fa-person fa-2xl"
                                    ></i>
                                  </template>
                                  <template
                                    v-for="(v, k) in value.so_tre_em"
                                    :key="k"
                                  >
                                    <i
                                      class="text-info fa-solid fa-baby fa-xl"
                                    ></i>
                                  </template>
                                </p>
                              </td>
                              <td class="text-end">
                                ...
                                <i class="text-wrap"
                                  >Giá mỗi đêm chưa bao gồm thuế và phí</i
                                >
                              </td>
                              <td rowspan="2">
                                <div class="d-flex flex-column">
                                  ...
                                  <button
                                    class="btn btn-outline-primary w-100 mt-2 mb-5 text-wrap"
                                  >
                                    Giỏ hàng
                                  </button>
                                </div>
