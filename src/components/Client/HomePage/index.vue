<template>
  ...
  >
    ...
    >
      ...
      <p
        class="hero-subtitle text-white mb-5 animate__animated animate__fadeInUp animate__delay-1s lead"
        style="font-size: 1.3rem; opacity: 0.92"
      >
      ...
      <div class="row g-5 align-items-center">
        <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
          ...
          <p class="text-muted lead mb-3">
            Nơi đây là điểm đến lý tưởng cho những ai đang tìm kiếm sự hoàn hảo
            trong mỗi chuyến đi.
          </p>
          <p class="text-muted mb-4">
            Vị trí đắc địa của chúng tôi nằm ngay tại trái tim thành phố, giúp
            bạn dễ dàng tiếp cận với các điểm tham quan nổi tiếng, nhà hàng, cửa
            hàng mua sắm và hoạt động giải trí sôi động.
          </p>
        </div>
          ...
          <div class="row g-3">
            ...
            >
              <div class="image-container rounded-3 overflow-hidden shadow-sm">
                <img
                  src="https://mona-hotel.monamedia.net/wp-content/uploads/2022/08/image-1.jpg"
                  alt="Hồ bơi resort"
            ...
            >
              <div class="image-container rounded-3 overflow-hidden shadow-sm">
                <img
                  src="https://mona-hotel.monamedia.net/wp-content/uploads/elementor/thumbs/image-2n-qnskkn93w2474ot7x21p35f3fbh9otaz3422c2sahw.jpg"
                  alt="Khách check-in"
                  class="w-100 h-100 object-fit-cover"
                />
              </div>
  ...
  >
    <div class="container">
      ...
      <div class="text-center mb-5">
        <p
          class="text-uppercase small mb-2"
          style="letter-spacing: 2px; font-weight: 500; color: #dbab57"
          data-aos="fade-down"
        >
                ...
                >
                  ...
                  >
                    ...
                    <img
                      :src="
                        phong.hinh_anh ||
                        'https://via.placeholder.com/600x400/1a1a1a/ffffff?text=Phòng'
                      "
...
>
  ...
  <section class="py-5 bg-light" id="review">
    <div class="container">
      <div class="text-center mb-5">
        <p
          class="text-uppercase small text-muted mb-2"
          style="letter-spacing: 2px; font-weight: 500"
          data-aos="fade-down"
        >
          ĐÁNH GIÁ CHẤT LƯỢNG
        </p>
        <h2 class="display-5 fw-bold text-dark" data-aos="fade-up">
          ...
          <template v-for="(chunk, index) in reviewChunks" :key="index">
            <div :class="['carousel-item', { active: index === 0 }]">
              <div class="row g-4 justify-content-center">
                ...
                >
                  <div
                    class="card border-0 shadow-sm rounded-4 h-100 position-relative overflow-hidden bg-white p-4"
                  ...
                  >
                    <div
                      class="position-absolute top-0 start-0 translate-middle-x mt-3 ms-3 text-gold opacity-25"
                    >
                      <i class="bx bxs-quote-left" style="font-size: 3rem"></i>
                    </div>
                    <p
                      class="text-muted small mb-4 lh-lg"
                      style="font-style: italic; min-height: 120px"
                    >
                      "{{ review.noi_dung }}"
                    </p>
                    <div class="d-flex align-items-center mt-auto">
                      ...
                      <div>
                        ...
                        <p class="text-muted small mb-0">
                          {{ review.chuc_vu || "Khách hàng" }}
                        </p>
                      </div>
                      <i
                        class="bx bxs-quote-right text-gold ms-auto"
        ...
        <div class="text-center mt-5">
          <div class="d-flex justify-content-center align-items-center gap-3">
            <div
              ...
              style="height: 4px; width: 120px; background: #e9ecef"
            >
              <div
  ...
  <section class="py-5 bg-white" id="amenities">
    <div class="container">
      ...
      <div class="row g-5 align-items-stretch">
        <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
          <div class="h-100 rounded-4 overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.0071726636675!2d108.19095897694739!3d16.065117584613827!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314219ab21c3d9ab%3A0x473424e86286cba4!2zMjQ1IELhur8gVsSDbiDEkMOgbiwgQ2jDrW5oIEdpw6FuLCBUaGFuaCBLaMOqLCDEkMOgIE7hurVuZyA1NTAwMDAsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1763018226481!5m2!1svi!2s"
              width="100%"
              height="100%"
        ...
        <div class="col-lg-6 d-flex" data-aos="fade-left" data-aos-delay="200">
          <div class="row g-4 flex-fill">
            ...
            >
              <div
                class="amenity-card flex-fill p-4 rounded-4 shadow-sm bg-light border-start border-warning border-5 d-flex flex-column"
              >
                <div class="d-flex align-items-center mb-3">
                  <i
                    :class="['bx', getAmenityIcon(n), 'text-gold', 'me-3']"
                    style="font-size: 2.2rem"
                  ></i>
                  <h5 class="fw-bold mb-0">{{ getAmenityTitle(n) }}</h5>
                </div>
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
          <div class="row g-4 align-items-center">
            ...
            <div class="col-md-7">
              ...
              <h3 class="fw-bold mb-3">Phòng gym</h3>
              <p class="text-muted mb-4">
                "Trang bị đầy đủ các thiết bị hiện đại và chuyên nghiệp, không
                gian rộng rãi, bạn có thể tập luyện và rèn luyện cơ thể một cách
                hiệu quả."
              </p>
              <router-link to="/gym#top" class="d-inline-block">
                <button
                  class="btn btn-warning text-white px-4 py-2 rounded-pill fw-semibold"
                >
                  ĐỌC THÊM
                </button>
              </router-link>
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
          <div class="row g-4 align-items-center">
            ...
            <div class="col-md-7 order-md-1">
              ...
              <h3 class="fw-bold mb-3">Nhà hàng</h3>
              <p class="text-muted mb-4">
                "Với thực đơn đa dạng từ các món ăn địa phương đến ẩm thực quốc
                tế, bạn sẽ được thưởng thức các món ăn tươi ngon và hương vị độc
                đáo."
              </p>
              <router-link to="/restaurant#top" class="d-inline-block">
                <button
                  class="btn btn-warning text-white px-4 py-2 rounded-pill fw-semibold"
                >
                  ĐỌC THÊM
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
          <div class="row g-4 align-items-center">
            ...
            <div class="col-md-7">
              ...
              <h3 class="fw-bold mb-3">Spa</h3>
              <p class="text-muted mb-4">
                "Trong không gian yên tĩnh và thư giãn của spa, bạn có thể tận
                hưởng các liệu pháp spa tuyệt vời để làm dịu cơ thể và tinh
                thần."
              </p>
              <router-link to="/spa#top" class="d-inline-block">
                <button
                  class="btn btn-warning text-white px-4 py-2 rounded-pill fw-semibold"
                >
                  ĐỌC THÊM
        ...
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
          <div class="row g-4 align-items-center">
            <div class="col-md-5 order-md-2">
              <img
                src="https://images.unsplash.com/photo-1509600110300-21b9d5fedeb7?w=600"
                alt="Hồ bơi"
                class="img-fluid rounded-4 shadow-sm"
              />
            </div>
            <div class="col-md-7 order-md-1">
              ...
              <h3 class="fw-bold mb-3">Hồ bơi</h3>
              <p class="text-muted mb-4">
                "Với nước trong xanh và không gian xung quanh thoáng đãng, bạn
                có thể tắm nắng, tập thể dục hoặc đơn giản là thư giãn trong
                nước."
              </p>
              <router-link to="/pool#top" class="d-inline-block">
                <button
                  class="btn btn-warning text-white px-4 py-2 rounded-pill fw-semibold"
                >
                  ĐỌC THÊM
...
export default {
  ...
  methods: {
    ...
    getAmenityDesc(n) {
      const descs = [
        "Dịch vụ đưa đón tiện lợi từ sân bay đến khách sạn và ngược lại, đảm bảo bạn có một chuyến đi dễ dàng và thoải mái.",
        "Chỗ đậu xe rộng rãi và an ninh, bạn có thể yên tâm về việc đỗ xe trong suốt thời gian lưu trú.",
        "Làm sạch và dọn dẹp phòng nghỉ hàng ngày, đảm bảo mọi thứ luôn sạch sẽ và gọn gàng.",
        "Hồ bơi rộng lớn và không gian thư giãn xung quanh, tận hưởng từng khoảnh khắc.",
        "Kết nối internet cáp quang tốc độ cao, kết nối nhanh chóng mọi lúc.",
        "Khởi đầu ngày mới với thực đơn đa dạng, món ăn tươi ngon và đặc sản địa phương.",
      ];
      return descs[n - 1];
    },
    inLog() {
      ...
      let Difference_In_Days = Math.max(
        1,
      ...
      this.ds_loai_phong.forEach((value, index) => {
        if (value.chon_phong && value.chon_phong == true) {
          ...
          this.info.so_tien =
            this.info.so_tien +
            value.so_phong_dat *
              parseInt(value.gia_trung_binh_ko_format) *
              Difference_In_Days;
          this.info.so_lon =
...
.btn-explore::before {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(135deg, #a07e47, #94630e);
  opacity: 0;
...
.btn-explore:hover {
  ...
  box-shadow: 0 20px 40px rgba(160, 104, 36, 0.5);
}
