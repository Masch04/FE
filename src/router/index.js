...
const routes = [
    ...
    // chi tiet thue phong
    {
        ...
        component: () =>
            import("../components/Admin/ChiTietThuePhong/index.vue"),
        beforeEnter: kiemTraAdmin,
    },
    // Tinh Trang Phong
    {
    ...
    },
    {
        ...
        component: () =>
            import("../components/Client/ChiTietBaiViet/index.vue"),
        meta: { layout: "client" },
        props: true,
    },
    {
        ...
        component: () =>
            import("../components/Client/DanhSachHoaDon/index.vue"),
        meta: { layout: "client" },
    },
    {
        path: "/profile",
    ...
    {
        path: "/restaurant",
        component: () => import("../components/Client/Restaurant/index.vue"),
        meta: { layout: "client" },
    },
    {
        path: "/spa",
        component: () => import("../components/Client/Spa/index.vue"),
        meta: { layout: "client" },
    },
    {
        path: "/pool",
        component: () => import("../components/Client/Pool/index.vue"),
        meta: { layout: "client" },
    },
    {
        path: "/gioi-thieu",
